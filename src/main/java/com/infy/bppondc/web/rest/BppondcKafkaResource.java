...
@RestController
@RequestMapping("/api/bppondc-kafka")
public class BppondcKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BppondcKafkaResource.class);
    ...
    public BppondcKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
