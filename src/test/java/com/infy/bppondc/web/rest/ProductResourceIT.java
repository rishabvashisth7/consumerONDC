...
import com.infy.bppondc.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    private static final LocalDate DEFAULT_EXPIRE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_EXPIRE = LocalDate.now(ZoneId.systemDefault());
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getExpire()).isEqualTo(DEFAULT_EXPIRE);
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).tag(UPDATED_TAG).expire(UPDATED_EXPIRE);
        ...
        assertThat(testProduct.getExpire()).isEqualTo(UPDATED_EXPIRE);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.expire(UPDATED_EXPIRE);
